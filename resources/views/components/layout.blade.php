        ...
        <div class="mt-8 md:mt-0 flex items-center">
            ...
            <x-dropdown>
                <x-slot name="trigger">
                    ...
                    <x-dropdown-item href="/user/{{ auth()->user()->id }}/posts" :active="request()->is('user/{{ auth()->user()->id }}/posts')">Your Posts
                    </x-dropdown-item>
            ...
            @can('admin')
                <div class="ml-5 mt-8 md:mt-0 flex items-center">
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button class="text-xs font-bold uppercase">Admin menu!</button>
                        </x-slot>
